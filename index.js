...
console.log( addFlavor( originalFlavors, "Rainbow Shrebret" ) );
console.log( ' ' );
...
console.log( removeLastFlavor( originalFlavors ) + " was removed from list" );
console.log( '' );
...
function getFlavorByIndex( arr, valueAt ) {
    return arr[ valueAt ];
}
...
function copy(arr, myArr){
    myArr = [ ...arr ];
    return myArr;
}

console.log( copy( originalFlavors, myArr ) );
console.log( '' );
